 ...
 * to [MAX_FARTS]). All present files are loaded into a [SoundPool] and [playFart]
 * picks a random ready one. Resources are resolved by name, so the app still builds
 * and simply stays quiet if no files have been added.
 */
